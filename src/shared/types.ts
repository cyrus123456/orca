...
export type GlobalSettings = {
  ...
  /** Kill switch for scrollback demotion (C1): eviction-exempt hidden worktrees drop to the minimum scrollback tier past the retention TTL. */
  terminalHiddenScrollbackDemotion?: boolean
